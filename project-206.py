...
#write your code here
	brake=lambda brake:carla.VehicleControl(hand_brake=brake)
	dropped_vehicle.apply_control(brake(True))
	time.sleep(5)
	speed = lambda speed: carla.VehicleControl(throttle=speed)
    dropped_vehicle.apply_control(speed(0.5))
    time.sleep(4)
    steering = lambda steer: carla.VehicleControl(throttle=steer)
    dropped_vehicle.apply_control(steering(-0.6))
    timr.sleep(5)
    speed = lambda speed: carla.VehicleControl(throttle=speed)
    dropped_vehicle.apply_control(speed(0.5))
    time.sleep(10)
    steering = lambda steer: carla.VehicleControl(throttle=steer)
    dropped_vehicle.apply_control(steering(0.3))
    time.sleep(5)
